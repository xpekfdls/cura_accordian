...
class CustomRepRapInfoPage(InfoPage):
	def __init__(self, parent):
		...
		self.AddSeperator()
		self.machineName = self.AddLabelTextCtrl(_("Machine name"), "neuron")
		self.machineWidth = self.AddLabelTextCtrl(_("Machine width (mm)"), "120")
		self.machineDepth = self.AddLabelTextCtrl(_("Machine depth (mm)"), "120")
		self.machineHeight = self.AddLabelTextCtrl(_("Machine height (mm)"), "120")
...
class MachineSelectPage(InfoPage):
	def __init__(self, parent):
		...
		self.Ultimaker2Radio = self.AddRadioButton("neuron", style=wx.RB_GROUP)
	...
	def StoreData(self):
		...
		if self.Ultimaker2Radio.GetValue():
			...
			profile.putMachineSetting('machine_height', '120')
			profile.putMachineSetting('machine_name', 'neuron')
			profile.putMachineSetting('machine_type', 'neuron')
...
class Ultimaker2ReadyPage(InfoPage):
	def __init__(self, parent):
		super(Ultimaker2ReadyPage, self).__init__(parent, "neuron")
		self.AddText('Congratulations on your the purchase of your brand new neuron.')
		self.AddText('Cura is now ready to be used with your neuron.')
		self.AddSeperator()
