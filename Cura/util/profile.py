...
setting('print_speed',                40, float, 'basic',    _('Speed and Temperature')).setRange(1).setLabel(_("Print speed (mm/s)"), _("Speed at which printing happens. A well adjusted Ultimaker can reach 150mm/s, but for good quality prints you want to print slower. Printing speed depends on a lot of factors. So you will be experimenting with optimal settings for this."))
...
setting('fan_full_height',           0.0, float, 'expert',   _('Cool')).setRange(0).setLabel(_("Fan full on at height (mm)"), _("The height at which the fan is turned on completely. For the layers below this the fan speed is scaled linearly with the fan off at layer 0."))
...
M106 S127 ; Turn on fan
G90 ; Absolute positioning
M82 ; Extruder in absolute mode
; Activate all used extruder
{IF_EXT0}M104 T0 S220
G92 E0 ; Reset extruder position
; Wait for all used extruders to reach temperature
{IF_EXT0}M109 T0 S220
;Put printing message on LCD screen
M117 Printing...
""", str, 'alteration', 'alteration')
#######################################################################################
setting('end.gcode', """;End GCode
G1 X0 Y0 Z115 ; Get extruder out of way. Uncomment to use!
M107 ; Turn off fan
...
setting('startMode_right', 'Show', ['Hide', 'Show'], 'preference', 'hidden')

setting('logincheck', 'True', ['True', 'False'], 'preference', 'hidden')
...
setting('model_colour', '#66C6F1', str, 'preference', 'hidden').setLabel(_('Model colour'), _('Display color for first extruder'))
...
setting('window_show_sash', '320', float, 'preference', 'hidden')
...
setting('machine_width', '130', float, 'machine', 'hidden').setLabel(_("Maximum width (mm)"), _("Size of the machine in mm"))
setting('machine_depth', '130', float, 'machine', 'hidden').setLabel(_("Maximum depth (mm)"), _("Size of the machine in mm"))
setting('machine_height', '110', float, 'machine', 'hidden').setLabel(_("Maximum height (mm)"), _("Size of the machine in mm"))
